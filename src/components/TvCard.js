...
export default function TvCard({socket, allPlayers, isConnected, setShowDisconnectedToast}){
    ...
    return (
        <div>
            <BackButton socket={socket} confirm={false} isConnected={isConnected} setShowDisconnectedToast={setShowDisconnectedToast}/>
